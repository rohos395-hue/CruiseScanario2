...
export class Stage extends StageBase<InitStateType, ChatStateType, MessageStateType, ConfigType> {
  ...
  /***  moveToLocation(location: string) {
    ...
    async beforePrompt(userMessage: Message): Promise<Partial<StageResponse<ChatStateType, MessageStateType>>> {
		...
		this.myInteralState.log+=" in beforeprompt"+this.myInternalState.sceneState.activeScene.id;
    ...
    async afterResponse(botMessage: Message): Promise<Partial<StageResponse<ChatStateType, MessageStateType>>> {
		...
		this.myInteralState.log+=" in afterprompt"+this.myInternalState.sceneState.activeScene.id;
